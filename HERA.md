...
Si no las defines, Hera usa los valores por defecto. En MacUp se controlan con
sliders desde Ajustes.

## Estilo por defecto recomendado (el "look" de MacUp)
...
En MacUp esto se fija en `src/components/theme-provider.tsx` (constantes
